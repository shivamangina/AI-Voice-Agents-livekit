...
This is the starter template for ElizaOS projects with **Telegram integration** support.

## Features

- Pre-configured project structure for ElizaOS development
- **Telegram bot integration** for direct message interactions
...
📖 **Detailed Telegram Setup**: See [TELEGRAM_SETUP.md](./TELEGRAM_SETUP.md) for complete configuration options and troubleshooting.
